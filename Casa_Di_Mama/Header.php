...
<html lang="en">
 ...
 <body>
    ...
    <?php } else { ?>
      <li><h3> <a href="abo_zonder_inloggen.php">Ons Abonnement</a></h3> </li>
    <?php } ?>
    <li><h3> <a href="javascript: document.body.scrollIntoView(false);">Contact</a></h3> </li>
    <?php if (isset($_SESSION['gebruikersnaam'])) { if( $_SESSION['gebruikersnaam'] != 'Admin'){ ?>
    ...
    <li><h3> <a href="overzichtklanten.php"> Klanten overzicht </a></h3></li>
    <?php }} ?>
	<?php if (isset($_SESSION['gebruikersnaam'])) { if($_SESSION['gebruikersnaam'] != 'admin'&& $_SESSION['gebruikersnaam'] != 'Admin'){ ?>
	<li><h3> <a href="bestelling.php">Jouw Bestellingen <?php($_SESSION['gebruikersnaam']) ?></a></h3> </li>
	<?php } else { ?>
	<li><h3> <a href="overzichtbestellingen.php">Bestel overzicht <?php ($_SESSION['gebruikersnaam']) ?></a></h3></li>
	<?php }} ?>
	<?php if (isset($_SESSION['gebruikersnaam'])) { if($_SESSION['gebruikersnaam'] != 'admin'&& $_SESSION['gebruikersnaam'] != 'Admin'){ ?>
	<li><h3> <a href="aboklant.php">Jouw Abonnementen <?php($_SESSION['gebruikersnaam']) ?></a></h3> </li>
	<?php } else { ?>
	<li><h3> <a href="overzichtabonnementen.php">Abonnement overzicht <?php ($_SESSION['gebruikersnaam']) ?></a></h3></li>
	<?php }} ?>
    </ul>
<!--
