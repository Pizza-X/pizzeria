...
--
-- Host: 127.0.0.1
-- Gegenereerd op: 10 okt 2019 om 13:54
...
INSERT INTO `abonnement` (`Abbonr`, `Klantnr`, `Dag`, `Datum`, `ProductID`) VALUES
(1, 1, '2019-10-10 17:01:30', '2019-10-10', 1);
...
--
ALTER TABLE `abonnement`
  MODIFY `Abbonr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `klant`
  MODIFY `Klantnr` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
-- Beperkingen voor tabel `abonnement`
--
ALTER TABLE `abonnement`
